...
export const ROAST_SCENES = {
  ...
  trait_02: 'Chronically late Saigon friend still lounging in bed scrolling TikTok under a blanket while texting "almost there", clock exploding, comedic time-elastic gag',
  ...
  trait_07: 'Young office worker joining a Zoom call 12 minutes late with fake "bad wifi" face while a green online dot glows on Discord, workplace comedy',
  ...
  trait_30: 'Friend cancelling plans at the last second with "too tired", already dressed at the door then flopping back onto the couch, flake-master comedy',
};
...
export function getRoastScenePrompt(id, indexHint = 0) {
  ...
  return finalizeResultImagePrompt(
    `Roast blacklist share-card poster. A funny "bad friend confession" card. Scene: ${scene}. Ho Chi Minh City Gen Z meme humor aesthetic, bold comedic energy, premium viral share look.`,
    { resultCode: indexHint, quizTitle: 'Thẻ đen bóc phốt', category: 'roast' },
  );
}
