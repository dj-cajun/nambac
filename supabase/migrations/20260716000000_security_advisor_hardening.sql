...
-- Legacy/mixed-case tables detected by Supabase Security Advisor.
-- These are not used by the current nambac runtime, so enabling RLS with no
-- anon/authenticated policy is the safest default: public REST access closes,
-- while service-role/server-side access can still be handled explicitly.
ALTER TABLE IF EXISTS "AdminAuditLog" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "AppSetting" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "Bookmark" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "Category" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "Comment" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "CommentDislike" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "CommentLike" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "ContentReport" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "Conversation" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "DirectMessage" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "EmailVerification" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "IpBlockEntry" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "LifeGuide" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "NewsIngestRun" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "NewsSourceConfig" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "Notification" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "PartnerBanner" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "PartnerEvent" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "PartnerStore" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "Post" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "PostAttachment" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "PostLike" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "SearchQueryStat" ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "StorageSnapshot" ENABLE ROW LEVEL SECURITY;
