...
* **ALL TEXT (Type Names, Descriptions) MUST BE IN VIETNAMESE.**
...
* **Axis 1 ($2^0, 1점$)**: [성향 A] vs [성향 B] (예: Introvert vs Extrovert)
* **Axis 2 ($2^1, 2점$)**: [성향 C] vs [성향 D] (예: Local vs Tourist)
* **Axis 3 ($2^2, 4점$)**: [성향 E] vs [성향 F] (예: Cheap Eats vs Luxury)
