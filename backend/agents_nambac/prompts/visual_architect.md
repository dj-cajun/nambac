...
* **ALL TEXT (Questions, Options) MUST BE IN VIETNAMESE.**
* **Style**: Ho Chi Minh Gen Z style. Use slang. Be funny.
...
* **Option A (0점)**: 해당 Axis의 'Low' 성향 (예: Nội tâm, Tiết kiệm, Kỹ tính)
* **Option B (가중치 점수)**: 해당 Axis의 'High' 성향 (예: Hướng ngoại, Ăn chơi, Thoải mái)
