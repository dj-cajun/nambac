...
* **Q1, Q2, Q3 (Determinant)**: Questions that determine Axis 1, 2, and 3 respectively.
  * **Q1**: Determine Axis 1 (bit 2). **Selecting Option B gives +4 points**.
  * **Q2**: Determine Axis 2 (bit 1). **Selecting Option B gives +2 points**.
  * **Q3**: Determine Axis 3 (bit 0). **Selecting Option B gives +1 point**.
