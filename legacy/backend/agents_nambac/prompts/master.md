> **Canonical source (2026-07)**: Runtime prompts live in `shared/quizPrompts.js` + `shared/quizExpertPrompts.js`.  
> This file is legacy reference for the old FastAPI agent workflow.
